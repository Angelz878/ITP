...
def AddCandidate():
    ...
    insert_sql = "INSERT INTO assignment (level, cohort, student_programme, intern_period, status, student_group, student_id, student_email, cgpa, supervisor_name, supervisor_email, student_name, student_NRIC, student_gender, remark, student_address, mobile_number) VALUES (%s, %s, %s, %s, 'status', %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
